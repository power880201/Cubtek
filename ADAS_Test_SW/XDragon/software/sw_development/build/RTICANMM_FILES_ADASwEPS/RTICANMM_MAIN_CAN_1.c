...
{                                                                                                                      
  ...
  static Int32 StartIdx[8] = {0, 33, 33, 33, 33, 33, 33, 33};                                                         
  static Int32 StopIdx[8]  = {32, 32, 32, 32, 32, 32, 32, 32};                                                         
  static Int32 NumOfIds[8] = {33, 0, 0, 0, 0, 0, 0, 0};                                                         
  Int32 MsgId = Msg->Id;                                                                                                     
     ...
     {                                                                                                                  
      ...
      do { /* while ((i < NUM_TX_MSG) && (j < (CANMMCAN_1_MAXMSGPERSTEP-(Int32)tx_queue_level)) && (j < CANMM_CTL_TX_QUEUE_SIZE(CANMM_CONTROLLER_ID))) */           
        ...
        if (ID_number != NOCANID) {                                                                                        
          ...
          switch (CANMMCAN_1_RXMT[ID_Table_TX(i)]) {                                                                                    
