...
#define CANMM_CONTROLLER_ID CANMM_CTL_SETUP_CAN_2                                                                                             
...
{                                                                                                                      
  ...
  static Int32 StartIdx[8] = {0, 65, 65, 65, 65, 65, 65, 65};                                                         
  static Int32 StopIdx[8]  = {64, 64, 64, 64, 64, 64, 64, 64};                                                         
  static Int32 NumOfIds[8] = {65, 0, 0, 0, 0, 0, 0, 0};                                                         
  Int32 MsgId = Msg->Id;                                                                                                     
     ...
     {                                                                                                                  
      ...
      do { /* while ((i < NUM_TX_MSG) && (j < (CANMMCAN_2_MAXMSGPERSTEP-(Int32)tx_queue_level)) && (j < CANMM_CTL_TX_QUEUE_SIZE(CANMM_CONTROLLER_ID))) */           
        ...
        if (ID_number != NOCANID) {                                                                                        
          ...
          switch (CANMMCAN_2_RXMT[ID_Table_TX(i)]) {                                                                                    
