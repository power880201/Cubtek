...
volatile UInt8 DECLSPEC CANMM_CTL_SETUP_CAN_1_ID;                                                                                     
volatile UInt8 DECLSPEC CANMM_CTL_SETUP_CAN_1_TX_STATUS        = 1;                                                                   
...
#if !defined(RTICANMM_HAVE_DSCAN_CHANNEL)                                                                          
void CANMM_CTL_SETUP_CAN_1_baudrate_set(Float64 baudrate) {                                                                           
  ...
  if ((res == CAN_TP1_BAUDRATE_L_ERROR || res == CAN_TP1_BAUDRATE_H_ERROR) && printInfo) {                                   
     msg_info_printf(MSG_SM_CANNEDY, RTICANMM_CANSFCN_BAUDRATE_RANGE_INFO,                                         
                     RTICANMM_CANSFCN_BAUDRATE_RANGE_INFO_TXT, "CAN_1",                                               
...
# else                                                                                                             
  ...
  CanMM_channel =                                                                                          
    can_tp1_channel_init(CAN_BOARD_BASE, CAN_CHANNELNO-1,                                                       
                             (CANMM_CTL_SETUP_CAN_1_baudrate * 1000), CAN_TYPE_MB15, CAN_TP1_NO_SUBINT);                           
    can_tp1_channel_termination_set(CanMM_channel, CAN_TP1_TERMINATION_OFF);                                                      
