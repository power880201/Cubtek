/*****************************************************************************************************************************/
/* MAIN S-FUNCTION for RTICANMM MainBlock (RTICANMM_MAIN_CAN_1.c) */
/*                                                                                                                           */
/*   AUTHOR(S):                                                                                                              */
/*      U. Homann                                                                                                              */
/*      M. Eikermann                                                                                                              */
...
#include "RTICANMM_MAIN_CAN_1_Globals.h"                                                                                                              
...
#define CANMM_CONTROLLER_ID CANMM_CTL_SETUP_CAN_1                                                                                             
...
{                                                                                                                      
  ...
  static Int32 StartIdx[2] = {0, 31};                                                                                 
  static Int32 StopIdx[2]  = {30, 30};                                                                                 
  static Int32 NumOfIds[2] = {31, 0};                                                                                 
  Int32 MsgId = Msg->Id;                                                                                               
  ...
  for (i=0; i<2; i++) {                                                                                            
    if( NumOfIds[MsgIDFormat]>0) {                                                                                 
      ...
      while (!found && (Start <= Stop)) {                                                                          
        ...
        Pos = (Start + Stop)>>1;                                                                                   
        if ((ID_Table_RX(Pos) == MsgId) && (Msg->Format == CANMMCAN_1_MIDFRX[Pos])) {                                             
          found = 1;                                                                                               
          break; // while                                                                                          
        }                                                                                                          
        else {                                                                                                     
...
#include CAN_MESSAGE_HEADERFILE                                                                                            
  ...
  {                                                                                                                        
      ...
      {                                                                                                                
          msg_error_printf(MSG_SM_CANNEDY, RTICANMM_MAINSFCN_MALLOC_ERROR , RTICANMM_MAINSFCN_MALLOC_ERROR_TXT, "CAN_1");
      }                                                                                                                
  }                                                                                                                        
  for (i = 0; i < NUM_TX_MSG; i++) {                                                                                   
...
{                                                                                                                          
  ...
  void **PWork = ssGetPWork(S);                                                                                            
      ...
      msg_info_printf(MSG_SM_CANNEDY, RTICANMM_MAINSFCN_MDL_START_INFO , RTICANMM_MAINSFCN_MDL_START_INFO_TXT, "CAN_1");  
#endif                                                                                                                     
  ...
  msg_info_printf(MSG_SM_CANNEDY, RTICANMM_MAINSFCN_MDL_START_CYCLETIME_INFO, RTICANMM_MAINSFCN_MDL_START_CYCLETIME_INFO_TXT, "CAN_1", TX_CYCLETIME[0]);
#endif                                                                                                                 
    ...
    while (CANMM_CTL_RX(CANMM_CONTROLLER_ID, &ctlsetup_client, &MsgData.CANMsg)) {                                            
      ...
      if(!MsgData.CANMsg.Loopback) {                                                                                       
        msg_info_printf(MSG_SM_CANNEDY, RTICANMM_MAINSFCN_RX_LOOPBACK_INFO,                                                
                        RTICANMM_MAINSFCN_RX_LOOPBACK_INFO_TXT, "CAN_1",                                                      
                        MsgData.CANMsg.Id,                                                                                 
        ...
        msg_info_printf(MSG_SM_CANNEDY, RTICANMM_MAINSFCN_RX_MSG_INFO, RTICANMM_MAINSFCN_RX_MSG_INFO_TXT, "CAN_1",            
                        MsgData.CANMsg.Id,                                                                                 
                        MsgData.CANMsg.TimeStamp,                                                                          
                        MsgData.CANMsg.Dlc,                                                                                
                        MsgData.CANMsg.Data[0]);                                                                           
      ...
      if (idIdx != -1) {                                                                                           
        ...
        CANMMCAN_1_RXt[idIdx] = MsgData.CANMsg.TimeStamp;                   
        if (MsgData.CANMsg.Loopback) {                          
          CANMMCAN_1_RXdt[idIdx] = MsgData.CANMsg.TimeStamp - TX_OLDTIME[idIdx];
          TX_OLDTIME[idIdx] = MsgData.CANMsg.TimeStamp;         
          CANMMCAN_1_RXsta[idIdx] = 1;                                    
        }                                                       
        else {                                                  
          CANMMCAN_1_RXdt[idIdx] = MsgData.CANMsg.TimeStamp - RX_OLDTIME[idIdx];
...
/* Set status of message (if message could basically be sent) -------------------------- */                                                            
     ...
     {                                                                                                                  
      ...
      j = 0;                                                                                                           
      i = 0;                                                                                                           
      if (CANMMCAN_1_MAXMSGPERSTEP < 1) {                                                                                                    
          if (MAX_TX_PERSTEP < 1) {                                                                                    
            CANMMCAN_1_MAXMSGPERSTEP = 1;                                                                                                    
          }                                                                                                            
          else {                                                                                                       
            CANMMCAN_1_MAXMSGPERSTEP = MAX_TX_PERSTEP;                                                                                       
          }                                                                                                            
      }                                                                                                                
                                                                                                                       
      do { /* while ((i < NUM_TX_MSG) && (j < (CANMMCAN_1_MAXMSGPERSTEP-(Int32)tx_queue_level)) && (j < CANMM_CTL_TX_QUEUE_SIZE(CANMM_CONTROLLER_ID))) */           
        UInt32 ID_number = TX_QUEUE(i).id;                                                                                 
        if (ID_number != NOCANID) {                                                                                        
          UInt8 TxMsgSent = 0;                                                                                             
                                                                                                                           
#if RTICANMM_LOGLEVEL > 3                                                                                                  
          msg_info_printf(MSG_SM_CANNEDY, RTICANMM_MAINSFCN_TX_MSG_INFO, RTICANMM_MAINSFCN_TX_MSG_INFO_TXT, "CAN_1",  ID_number);
#endif                                                                                                                     
                                                                                                                           
          if (RTICANMM_MESSAGE_TYPE_STD == CANMMCAN_1_RXMT[ID_Table_TX(i)] || RTICANMM_MESSAGE_TYPE_EXT == CANMMCAN_1_RXMT[ID_Table_TX(i)]) {        
            MsgData.pData = MsgData.CANMsg.Data;                                                                           
        ...
        i++;                                                                                                               
      } while ((i < NUM_TX_MSG) && (j < (CANMMCAN_1_MAXMSGPERSTEP-(Int32)tx_queue_level)) && (j < CANMM_CTL_TX_QUEUE_SIZE(CANMM_CONTROLLER_ID)));       
    }                                                                                                                  
