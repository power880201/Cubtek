function ObstacleListBus() 
% OBSTACLELISTBUS initializes a set of bus objects in the MATLAB base workspace 

% Bus object: ObstacleList 
clear elems;
...
elems(9).Name = 'obstacleType';
elems(9).Dimensions = [60 10];
...
elems(10).Name = 'obstacleStatus';
elems(10).Dimensions = [60 10];
...
elems(11).Name = 'length';
elems(11).Dimensions = [60 10];
...
elems(13).Name = 'angleRate';
elems(13).Dimensions = [60 10];
...
elems(16).Name = 'obstacleTimestamp';
elems(16).Dimensions = [60 10];
elems(16).DimensionsMode = 'Fixed';
elems(16).DataType = 'uint8';
...
elems(17).Name = 'cipvFlag';
elems(17).Dimensions = [60 10];
...
ObstacleList = Simulink.Bus;
ObstacleList.HeaderFile = '';
ObstacleList.Description = '';
ObstacleList.DataScope = 'Auto';
ObstacleList.Alignment = -1;
ObstacleList.Elements = elems;
clear elems;
assignin('base','ObstacleList', ObstacleList);
